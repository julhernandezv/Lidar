...
setup(
    ...
    url='https://github.com/julhernandezv/EDA.git',
    license='LICENSE.txt',
    description="Environmental Data Analyst: Package for manipulating Satellite, Ground-based Remote Sensing and in situ measurement stations.",
